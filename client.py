...
def gameWindow():
    ...
    canvas2.create_text( screen_width/3,50, text = "Tambola Family Fun", font=("Chalkboard SE",50), fill="#3e2723")
    
    createTicket()
    placeNumbers()

    flashNumberLabel = canvas2.create_text(400,screen_height/1.5, text = "Waiting for other to join...", font=("Chalkboard SE",30), fill="#3e2723")
